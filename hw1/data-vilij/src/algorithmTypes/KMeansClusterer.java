...
public class KMeansClusterer extends Clusterer {
    ...
    public KMeansClusterer(DataSet dataset, int maxIterations, int updateInterval, int numberOfClusters, boolean continuousRun, ApplicationTemplate appTemp) {
        ...
        this.applicationTemplate = appTemp;
        count = 1;
    }
